if (function(t, e) {
        ...
        function i(t) {
            var e = Ee[t] = {};
            return ce.each(t.match(fe) || [], function(t, n) {
                e[n] = !0
            }), e
        }
        ...
        function s(t, n, i) {
            if (i === e && 1 === t.nodeType) {
                ...
                if (i = t.getAttribute(o), "string" == typeof i) {
                    try {
                        i = "true" === i ? !0 : "false" === i ? !1 : "null" === i ? null : +i + "" === i ? +i : Ne.test(i) ? ce.parseJSON(i) : i
                    } catch (r) {}
                    ce.data(t, n, i)
                } else i = e
            }
        ...
        function f(t, e, n) {
            ...
            if ("string" == typeof e) {
                if (Re.test(e)) return ce.filter(e, t, n);
                e = ce.filter(e, t)
            }
        ...
        function x(t, n) {
            var i, o, r = 0,
                s = typeof t.getElementsByTagName !== V ? t.getElementsByTagName(n || "*") : typeof t.querySelectorAll !== V ? t.querySelectorAll(n || "*") : e;
            if (!s)
                for (s = [], i = t.childNodes || t; null != (o = i[r]); r++) !n || ce.nodeName(o, n) ? s.push(o) : ce.merge(s, x(o, n));
        ...
        function k(t, e) {
            for (var n, i, o, r = [], s = 0, a = t.length; a > s; s++) i = t[s], i.style && (r[s] = ce._data(i, "olddisplay"), n = i.style.display, e ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && C(i) && (r[s] = ce._data(i, "olddisplay", $(i.nodeName)))) : r[s] || (o = C(i), (n && "none" !== n || !o) && ce._data(i, "olddisplay", o ? n : ce.css(i, "display"))));
        ...
        function N(t, e, n, i, o) {
            for (var r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > r; r += 2) "margin" === n && (s += ce.css(t, n + kn[r], !0, o)), i ? ("content" === n && (s -= ce.css(t, "padding" + kn[r], !0, o)), "margin" !== n && (s -= ce.css(t, "border" + kn[r] + "Width", !0, o))) : (s += ce.css(t, "padding" + kn[r], !0, o), "padding" !== n && (s += ce.css(t, "border" + kn[r] + "Width", !0, o)));
            return s
        }
        ...
        function S(t, e, n) {
            ...
            if (0 >= o || null == o) {
                if (o = fn(t, e, r), (0 > o || null == o) && (o = t.style[e]), bn.test(o)) return o;
        ...
        function $(t) {
            var e = J,
                n = wn[t];
            return n || (n = D(t, e), "none" !== n && n || (cn = (cn || ce("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(e.documentElement), e = (cn[0].contentWindow || cn[0].contentDocument).document, e.write("<!doctype html><html><body>"), e.close(), n = D(t, e), cn.detach()), wn[t] = n), n
        }
        ...
        function A(t, e, n, i) {
            ...
            if (ce.isArray(e)) ce.each(e, function(e, o) {
                n || Sn.test(t) ? i(t, o) : A(t + "[" + ("object" == typeof o ? e : "") + "]", o, n, i)
            });
            else if (n || "object" !== ce.type(e)) i(t, e);
            else
                for (o in e) A(t + "[" + o + "]", e[o], n, i)
        }
        ...
        function W(t, e, n) {
            var i, o, r = 0,
                ...
                l = function() {
                    if (o) return !1;
                    for (var e = Zn || _(), n = Math.max(0, u.startTime + u.duration - e), i = n / u.duration || 0, r = 1 - i, s = 0, l = u.tweens.length; l > s; s++) u.tweens[s].run(r);
            ...
            return ce.map(c, M, u), ce.isFunction(u.opts.start) && u.opts.start.call(t, u), ce.fx.timer(ce.extend(l, {
                elem: t,
                anim: u,
                queue: u.opts.queue
        ...
        function R(t, e, n) {
            ...
            })), 1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], "inline" === ce.css(t, "display") && "none" === ce.css(t, "float") && (ce.support.inlineBlockNeedsLayout && "inline" !== $(t.nodeName) ? p.zoom = 1 : p.display = "inline-block")), n.overflow && (p.overflow = "hidden", ce.support.shrinkWrapBlocks || u.always(function() {
                p.overflow = n.overflow[0], p.overflowX = n.overflow[1], p.overflowY = n.overflow[2]
            }));
            for (i in e)
                if (o = e[i], ei.exec(o)) {
                    if (delete e[i], r = r || "toggle" === o, o === (f ? "hide" : "show")) continue;
                    c[i] = d && d[i] || ce.style(t, i)
                }
            if (!ce.isEmptyObject(c)) {
                d ? "hidden" in d && (f = d.hidden) : d = ce._data(t, "fxshow", {}), r && (d.hidden = !f), f ? ce(t).show() : u.done(function() {
                    ce(t).hide()
                }), u.done(function() {
                    var e;
                ...
                for (i in c) s = M(f ? d[i] : 0, i, u), i in d || (d[i] = s.start, f && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
            }
        }
        ...
        var X, Q, V = typeof e,
            ...
            Ce = function(t) {
                (J.addEventListener || "load" === t.type || "complete" === J.readyState) && (ke(), ce.ready())
            },
            ke = function() {
        ...
        ce.fn = ce.prototype = {
                ...
                ready: function(t) {
                    if (t === !0 ? !--ce.readyWait : !ce.isReady) {
                        ...
                        ce.isReady = !0, t !== !0 && --ce.readyWait > 0 || (X.resolveWith(J, [ce]), ce.fn.trigger && ce(J).trigger("ready").off("ready"))
                    }
                },
                ...
                camelCase: function(t) {
                    return t.replace(xe, "ms-").replace(we, Te)
                },
                ...
                if (!X)
                    if (X = ce.Deferred(), "complete" === J.readyState) setTimeout(ce.ready);
            ...
            function(t, e) {
                function n(t, e, n, i) {
                    var o, r, s, a, l, u, c, p, h, m;
                    if ((e ? e.ownerDocument || e : W) !== L && j(e), e = e || L, n = n || [], !t || "string" != typeof t) return n;
                    ...
                    if (F && !i) {
                        if (o = be.exec(t))
                            if (s = o[1]) {
                                ...
                                if ((s = o[3]) && C.getElementsByClassName && e.getElementsByClassName) return te.apply(n, e.getElementsByClassName(s)), n
                            }
                        if (C.qsa && (!O || !O.test(t))) {
                            if (p = c = M, h = e, m = 9 === a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                                for (u = f(t), (c = e.getAttribute("id")) ? p = c.replace(Te, "\\$&") : e.setAttribute("id", p), p = "[id='" + p + "'] ", l = u.length; l--;) u[l] = p + d(u[l]);
                                h = de.test(t) && e.parentNode || e, m = u.join(",")
                            }
                            if (m) try {
                ...
                function f(t, e) {
                    ...
                    for (a = t, l = [], u = E.preFilter; a;) {
                        (!i || (o = pe.exec(a))) && (o && (a = a.slice(o[0].length) || a), l.push(r = [])), i = !1, (o = fe.exec(a)) && (i = o.shift(), r.push({
                            value: i,
                            type: o[0].replace(ue, " ")
                        }), a = a.slice(i.length));
                        for (s in E.filter) !(o = ye[s].exec(a)) || u[s] && !(o = u[s](o)) || (i = o.shift(), r.push({
                            value: i,
                            type: s,
                            matches: o
                        }), a = a.slice(i.length));
                ...
                function y(t, e, n, i, r, s) {
                    return i && !i[M] && (i = y(i)), r && !r[M] && (r = y(r, s)), o(function(o, s, a, l) {
                        var u, c, p, f = [],
                            d = [],
                            h = s.length,
                            m = o || x(e || "*", a.nodeType ? [a] : a, []),
                            y = !t || !o && e ? m : g(m, f, t, a, l),
                            v = n ? r || (o ? t : h || i) ? [] : s : y;
                        if (n && n(y, v, a, l), i)
                            for (u = g(v, d), i(u, [], a, l), c = u.length; c--;)(p = u[c]) && (v[d[c]] = !(y[d[c]] = p));
                        if (o) {
                            if (r || t) {
                                if (r) {
                                ...
                                for (c = v.length; c--;)(p = v[c]) && (u = r ? ne.call(o, p) : f[c]) > -1 && (o[u] = !(s[u] = p))
                            }
                        } else v = g(v === s ? v.splice(h, v.length) : v), r ? r(null, s, v, l) : te.apply(s, v)
                    })
                }
                ...
                function v(t) {
                    for (var e, n, i, o = t.length, r = E.relative[t[0].type], s = r || E.relative[" "], a = r ? 1 : 0, l = h(function(t) {
                            ...
                            return !r && (i || n !== D) || ((e = n).nodeType ? l(t, n, i) : u(t, n, i))
                        }]; o > a; a++)
                        if (n = E.relative[t[a].type]) c = [h(m(c), n)];
                        else {
                            if (n = E.filter[t[a].type].apply(null, t[a].matches), n[M]) {
                                ...
                                return y(a > 1 && m(c), a > 1 && d(t.slice(0, a - 1).concat({
                                    value: " " === t[a - 2].type ? "*" : ""
                                })).replace(ue, "$1"), n, i > a && v(t.slice(a, i)), o > i && v(t = t.slice(i)), o > i && d(t))
                            }
                            c.push(n)
                        }
                    return m(c)
                    ...
                    var i = 0,
                        ...
                        a = function(o, a, l, u, c) {
                            var p, f, d, h = [],
                                ...
                                b = null != c,
                                x = D,
                                w = o || s && E.find.TAG("*", c && a.parentNode || a),
                                T = B += null == x ? 1 : Math.random() || .1;
                            for (b && (D = a !== L && a, k = i); null != (p = w[y]); y++) {
                                if (s && p) {
                                    for (f = 0; d = t[f++];)
                                        if (d(p, a, l)) {
                                            u.push(p);
                            ...
                            if (m += y, r && y !== m) {
                                for (f = 0; d = e[f++];) d(v, h, a, l);
                                if (o) {
                                    if (m > 0)
                                        for (; y--;) v[y] || h[y] || (h[y] = K.call(u));
                                    h = g(h)
                                }
                                te.apply(u, h), b && !o && h.length > 0 && m + e.length > 1 && n.uniqueSort(u)
                            }
                            return b && (B = T, D = x), v
                        };
                    return r ? o(a) : a
                ...
                function w(t, e, n, i) {
                    var o, r, s, a, l, u = f(t);
                    if (!i && 1 === u.length) {
                        if (r = u[0] = u[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && C.getById && 9 === e.nodeType && F && E.relative[r[1].type]) {
                            if (e = (E.find.ID(s.matches[0].replace(Ce, ke), e) || [])[0], !e) return n;
                            t = t.slice(r.shift().value.length)
                        }
                        for (o = ye.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !E.relative[a = s.type]);)
                            if ((l = E.find[a]) && (i = l(s.matches[0].replace(Ce, ke), de.test(r[0].type) && e.parentNode || e))) {
                                if (r.splice(o, 1), t = i.length && d(r), !t) return te.apply(n, i), n;
                                break
                            }
                    }
                    return $(t, u)(i, e, !F, n, de.test(t)), n
                }
                var T, C, k, E, N, S, $, D, A, j, L, H, F, O, q, P, _, M = "sizzle" + -new Date,
                    W = t.document,
                    B = 0,
                    R = 0,
                    I = i(),
                    ...
                    we = /^h\d$/i,
                    Te = /'|\\/g,
                    Ce = RegExp("\\\\([\\da-f]{1,6}" + oe + "?|(" + oe + ")|.)", "ig"),
                    ke = function(t, e, n) {
                        var i = "0x" + e - 65536;
                        return i !== i || n ? e : 0 > i ? String.fromCharCode(i + 65536) : String.fromCharCode(55296 | i >> 10, 56320 | 1023 & i)
                    };
                try {
                    te.apply(G = ee.call(W.childNodes), W.childNodes), G[W.childNodes.length].nodeType
                } catch (Ee) {
                    te = {
                ...
                S = n.isXML = function(t) {
                ...
                }, C = n.support = {}, j = n.setDocument = function(t) {
                    var n = t ? t.ownerDocument || t : W,
                        i = n.defaultView;
                    return n !== L && 9 === n.nodeType && n.documentElement ? (L = n, H = n.documentElement, F = !S(n), i && i.attachEvent && i !== i.top && i.attachEvent("onbeforeunload", function() {
                        j()
                        ...
                        return H.appendChild(t).id = M, !n.getElementsByName || !n.getElementsByName(M).length
                    }), C.getById ? (E.find.ID = function(t, e) {
                        if (typeof e.getElementById !== V && F) {
                    ...
                    }), E.find.TAG = C.getElementsByTagName ? function(t, n) {
                        ...
                        return r
                    }, E.find.CLASS = C.getElementsByClassName && function(t, n) {
                        return typeof n.getElementsByClassName !== V && F ? n.getElementsByClassName(t) : e
                    }, q = [], O = [], (C.qsa = ve.test(n.querySelectorAll)) && (r(function(t) {
                        t.innerHTML = "<select><option selected=''></option></select>", t.querySelectorAll("[selected]").length || O.push("\\[" + oe + "*(?:value|" + ie + ")"), t.querySelectorAll(":checked").length || O.push(":checked")
                    }), r(function(t) {
                        var e = n.createElement("input");
                        e.setAttribute("type", "hidden"), t.appendChild(e).setAttribute("t", ""), t.querySelectorAll("[t^='']").length && O.push("[*^$]=" + oe + "*(?:''|\"\")"), t.querySelectorAll(":enabled").length || O.push(":enabled", ":disabled"), t.querySelectorAll("*,:x"), O.push(",.*:")
                    })), (C.matchesSelector = ve.test(P = H.webkitMatchesSelector || H.mozMatchesSelector || H.oMatchesSelector || H.msMatchesSelector)) && r(function(t) {
                        C.disconnectedMatch = P.call(t, "div"), P.call(t, "[s!='']:x"), q.push("!=", le)
                    }), O = O.length && RegExp(O.join("|")), q = q.length && RegExp(q.join("|")), _ = ve.test(H.contains) || H.compareDocumentPosition ? function(t, e) {
                        ...
                        if (e)
                            for (; e = e.parentNode;)
                                if (e === t) return !0;
                        return !1
                    }, Q = H.compareDocumentPosition ? function(t, e) {
                        if (t === e) return X = !0, 0;
                        var i = e.compareDocumentPosition && t.compareDocumentPosition && t.compareDocumentPosition(e);
                        return i ? 1 & i || !C.sortDetached && e.compareDocumentPosition(t) === i ? t === n || _(W, t) ? -1 : e === n || _(W, e) ? 1 : A ? ne.call(A, t) - ne.call(A, e) : 0 : 4 & i ? -1 : 1 : t.compareDocumentPosition ? -1 : 1
                    } : function(t, e) {
                        var i, o = 0,
                            r = t.parentNode,
                            s = e.parentNode,
                            ...
                            u = [e];
                        if (t === e) return X = !0, 0;
                        if (!r || !s) return t === n ? -1 : e === n ? 1 : r ? -1 : s ? 1 : A ? ne.call(A, t) - ne.call(A, e) : 0;
                        if (r === s) return a(t, e);
                    ...
                    if ((t.ownerDocument || t) !== L && j(t), e = e.replace(he, "='$1']"), !(!C.matchesSelector || !F || q && q.test(e) || O && O.test(e))) try {
                        var i = P.call(t, e);
                    ...
                    var i = E.attrHandle[n.toLowerCase()],
                        o = i && J.call(E.attrHandle, n.toLowerCase()) ? i(t, n, !F) : e;
                    return o === e ? C.attributes || !F ? t.getAttribute(n) : (o = t.getAttributeNode(n)) && o.specified ? o.value : null : o
                }, n.error = function(t) {
                    ...
                    var e, n = [],
                        i = 0,
                        o = 0;
                    if (X = !C.detectDuplicates, A = !C.sortStable && t.slice(0), t.sort(Q), X) {
                    ...
                    filter: {
                        ...
                        CLASS: function(t) {
                            var e = I[t + " "];
                            return e || (e = RegExp("(^|" + oe + ")" + t + "(" + oe + "|$)")) && I(t, function(t) {
                        ...
                        CHILD: function(t, e, n, i, o) {
                            ...
                            return 1 === i && 0 === o ? function(t) {
                                ...
                                var u, c, p, f, d, h, m = r !== s ? "nextSibling" : "previousSibling",
                                    g = e.parentNode,
                                ...
                                if (g) {
                                    ...
                                    if (h = [s ? g.firstChild : g.lastChild], s && v) {
                                        for (c = g[M] || (g[M] = {}), u = c[t] || [], d = u[0] === B && u[1], f = u[0] === B && u[2], p = d && g.childNodes[d]; p = ++d && p && p[m] || (f = d = 0) || h.pop();)
                                            if (1 === p.nodeType && ++f && p === e) {
                                                c[t] = [B, d, f];
                                                break
                                            }
                                    } else if (v && (u = (e[M] || (e[M] = {}))[t]) && u[0] === B) f = u[1];
                                    else
                                        for (;
                                            (p = ++d && p && p[m] || (f = d = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== y : 1 !== p.nodeType) || !++f || (v && ((p[M] || (p[M] = {}))[t] = [B, f]), p !== e)););
                        ...
                        PSEUDO: function(t, e) {
                            ...
                            return r[M] ? r(e) : r.length > 1 ? (i = [t, t, "", e], E.setFilters.hasOwnProperty(t.toLowerCase()) ? o(function(t, n) {
                    ...
                    pseudos: {
                        ...
                        lang: o(function(t) {
                            return ge.test(t || "") || n.error("unsupported lang: " + t), t = t.replace(Ce, ke).toLowerCase(),
                                function(e) {
                                    var n;
                                    do
                ...
                p.prototype = E.filters = E.pseudos, E.setFilters = new p, $ = n.compile = function(t, e) {
                    var n, i = [],
                        o = [],
                        r = z[t + " "];
                    if (!r) {
                        for (e || (e = f(t)), n = e.length; n--;) r = v(e[n]), r[M] ? i.push(r) : o.push(r);
                        r = z(t, b(o, i))
                    }
                    return r
                }, C.sortStable = M.split("").sort(Q).join("") === M, C.detectDuplicates = X, j(), C.sortDetached = r(function(t) {
        ...
        ce.Callbacks = function(t) {
            ...
            var n, o, r, s, a, l, u = [],
                ...
                p = function(e) {
                    ...
                    n = !1, u && (c ? c.length && p(c.shift()) : o ? u = [] : f.disable())
                },
                f = {
                    add: function() {
                        if (u) {
                            ...
                            ! function i(e) {
                                ce.each(e, function(e, n) {
                                    var o = ce.type(n);
                                    "function" === o ? t.unique && f.has(n) || u.push(n) : n && n.length && "string" !== o && i(n)
                                })
                    ...
                    lock: function() {
                        return c = e, o || f.disable(), this
                    },
                    locked: function() {
                        return !c
                    },
                    fireWith: function(t, e) {
                        return !u || r && !c || (e = e || [], e = [t, e.slice ? e.slice() : e], n ? c.push(e) : p(e)), this
                    },
                    fire: function() {
            ...
            return e.ownLast = "0" !== c, ce(function() {
                ...
                s && (n = J.createElement("div"), n.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", s.appendChild(n).appendChild(p), p.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", o = p.getElementsByTagName("td"), o[0].style.cssText = "padding:0;margin:0;border:0;display:none", u = 0 === o[0].offsetHeight, o[0].style.display = "", o[1].style.display = "none", e.reliableHiddenOffsets = u && 0 === o[0].offsetHeight, p.innerHTML = "", p.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", ce.swap(s, null != s.style.zoom ? {
                    ...
                    width: "4px"
                }).width, i = p.appendChild(J.createElement("div")), i.style.cssText = p.style.cssText = r, i.style.marginRight = i.style.width = "0", p.style.width = "1px", e.reliableMarginRight = !parseFloat((t.getComputedStyle(i, null) || {}).marginRight)), typeof p.style.zoom !== V && (p.innerHTML = "", p.style.cssText = r + "width:1px;padding:1px;display:inline;zoom:1", e.inlineBlockNeedsLayout = 3 === p.offsetWidth, p.style.display = "block", p.innerHTML = "<div></div>", p.firstChild.style.width = "5px", e.shrinkWrapBlocks = 3 !== p.offsetWidth, e.inlineBlockNeedsLayout && (s.style.zoom = 1)), s.removeChild(n), n = p = o = i = null)
            }), n = r = s = a = i = o = null, e
        }({});
        var Ne = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/,
            Se = /([A-Z])/g;
        ...
        ce.fn.extend({
            ...
            toggleClass: function(t, e) {
                var n = typeof t;
                return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : this.each(ce.isFunction(t) ? function(n) {
                    ce(this).toggleClass(t.call(this, n, this.className, e), e)
                } : function() {
                    if ("string" === n)
                        for (var e, i = 0, o = ce(this), r = t.match(fe) || []; e = r[i++];) o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
            ...
            val: function(t) {
                ...
                })) : r ? (i = ce.valHooks[r.type] || ce.valHooks[r.nodeName.toLowerCase()], i && "get" in i && (n = i.get(r, "value")) !== e ? n : (n = r.value, "string" == typeof n ? n.replace(je, "") : null == n ? "" : n)) : void 0
            }
        }), ce.extend({
            valHooks: {
                option: {
            ...
            attr: function(t, n, i) {
                ...
                return t && 3 !== s && 8 !== s && 2 !== s ? typeof t.getAttribute === V ? ce.prop(t, n, i) : (1 === s && ce.isXMLDoc(t) || (n = n.toLowerCase(), o = ce.attrHooks[n] || (ce.expr.match.bool.test(n) ? De : $e)), i === e ? o && "get" in o && null !== (r = o.get(t, n)) ? r : (r = ce.find.attr(t, n), null == r ? e : r) : null !== i ? o && "set" in o && (r = o.set(t, i, n)) !== e ? r : (t.setAttribute(n, i + ""), i) : (ce.removeAttr(t, n), e)) : void 0
            },
            removeAttr: function(t, e) {
                var n, i, o = 0,
                    r = e && e.match(fe);
                if (r && 1 === t.nodeType)
                    for (; n = r[o++];) i = ce.propFix[n] || n, ce.expr.match.bool.test(n) ? qe && Oe || !Fe.test(n) ? t[i] = !1 : t[ce.camelCase("default-" + n)] = t[i] = !1 : ce.attr(t, n, ""), t.removeAttribute(Oe ? n : i)
            },
            attrHooks: {
                type: {
                    set: function(t, e) {
            ...
            set: function(t, e, n) {
                return e === !1 ? ce.removeAttr(t, n) : qe && Oe || !Fe.test(n) ? t.setAttribute(!Oe && ce.propFix[n] || n, n) : t[ce.camelCase("default-" + n)] = t[n] = !0, n
            }
        }, ce.each(ce.expr.match.bool.source.match(/\w+/g), function(t, n) {
            var i = ce.expr.attrHandle[n] || ce.find.attr;
            ce.expr.attrHandle[n] = qe && Oe || !Fe.test(n) ? function(t, n, o) {
        ...
        }), qe && Oe || (ce.attrHooks.value = {
            set: function(t, n, i) {
                return ce.nodeName(t, "input") ? (t.defaultValue = n, e) : $e && $e.set(t, n, i)
            }
        }), Oe || ($e = {
            set: function(t, n, i) {
        ...
        ce.event = {
            ...
            add: function(t, n, i, o, r) {
                var s, a, l, u, c, p, f, d, h, m, g, y = ce._data(t);
                if (y) {
                    for (i.handler && (u = i, i = u.handler, r = u.selector), i.guid || (i.guid = ce.guid++), (a = y.events) || (a = y.events = {}), (p = y.handle) || (p = y.handle = function(t) {
                        ...
                        }, p.elem = t), n = (n || "").match(fe) || [""], l = n.length; l--;) s = Be.exec(n[l]) || [], h = g = s[1], m = (s[2] || "").split(".").sort(), h && (c = ce.event.special[h] || {}, h = (r ? c.delegateType : c.bindType) || h, c = ce.event.special[h] || {}, f = ce.extend({
                        type: h,
                        origType: g,
                        data: o,
                        handler: i,
                        ...
                        namespace: m.join(".")
                    }, u), (d = a[h]) || (d = a[h] = [], d.delegateCount = 0, c.setup && c.setup.call(t, o, m, p) !== !1 || (t.addEventListener ? t.addEventListener(h, p, !1) : t.attachEvent && t.attachEvent("on" + h, p))), c.add && (c.add.call(t, f), f.handler.guid || (f.handler.guid = i.guid)), r ? d.splice(d.delegateCount++, 0, f) : d.push(f), ce.event.global[h] = !0);
                    t = null
                }
            },
            remove: function(t, e, n, i, o) {
                var r, s, a, l, u, c, p, f, d, h, m, g = ce.hasData(t) && ce._data(t);
                if (g && (c = g.events)) {
                    for (e = (e || "").match(fe) || [""], u = e.length; u--;)
                        if (a = Be.exec(e[u]) || [], d = m = a[1], h = (a[2] || "").split(".").sort(), d) {
                            for (p = ce.event.special[d] || {}, d = (i ? p.delegateType : p.bindType) || d, f = c[d] || [], a = a[2] && RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = r = f.length; r--;) s = f[r], !o && m !== s.origType || n && n.guid !== s.guid || a && !a.test(s.namespace) || i && i !== s.selector && ("**" !== i || !s.selector) || (f.splice(r, 1), s.selector && f.delegateCount--, p.remove && p.remove.call(t, s));
                            l && !f.length && (p.teardown && p.teardown.call(t, h, g.handle) !== !1 || ce.removeEvent(t, d, g.handle), delete c[d])
                        } else
                            for (d in c) ce.event.remove(t, d + e[u], n, i, !0);
                    ce.isEmptyObject(c) && (delete g.handle, ce._removeData(t, "events"))
                }
            },
            trigger: function(n, i, o, r) {
                var s, a, l, u, c, p, f, d = [o || J],
                    h = le.call(n, "type") ? n.type : n,
                    m = le.call(n, "namespace") ? n.namespace.split(".") : [];
                if (l = p = o = o || J, 3 !== o.nodeType && 8 !== o.nodeType && !We.test(h + ce.event.triggered) && (h.indexOf(".") >= 0 && (m = h.split("."), h = m.shift(), m.sort()), a = 0 > h.indexOf(":") && "on" + h, n = n[ce.expando] ? n : new ce.Event(h, "object" == typeof n && n), n.isTrigger = r ? 2 : 3, n.namespace = m.join("."), n.namespace_re = n.namespace ? RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, n.result = e, n.target || (n.target = o), i = null == i ? [n] : ce.makeArray(i, [n]), c = ce.event.special[h] || {}, r || !c.trigger || c.trigger.apply(o, i) !== !1)) {
                    if (!r && !c.noBubble && !ce.isWindow(o)) {
                        for (u = c.delegateType || h, We.test(u + h) || (l = l.parentNode); l; l = l.parentNode) d.push(l), p = l;
                        p === (o.ownerDocument || J) && d.push(p.defaultView || p.parentWindow || t)
                    }
                    for (f = 0;
                        (l = d[f++]) && !n.isPropagationStopped();) n.type = f > 1 ? u : c.bindType || h, s = (ce._data(l, "events") || {})[n.type] && ce._data(l, "handle"), s && s.apply(l, i), s = a && l[a], s && ce.acceptData(l) && s.apply && s.apply(l, i) === !1 && n.preventDefault();
                    if (n.type = h, !r && !n.isDefaultPrevented() && (!c._default || c._default.apply(d.pop(), i) === !1) && ce.acceptData(o) && a && o[h] && !ce.isWindow(o)) {
            ...
            fix: function(t) {
                ...
                var e, n, i, o = t.type,
                    r = t,
                    s = this.fixHooks[o];
                for (s || (this.fixHooks[o] = s = Me.test(o) ? this.mouseHooks : _e.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, t = new ce.Event(r), e = i.length; e--;) n = i[e], t[n] = r[n];
            ...
            setup: function() {
                return Pe.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (ce.event.add(this, "propertychange._change", function(t) {
                    ...
                    var e = t.target;
                    Pe.test(e.nodeName) && !ce._data(e, "changeBubbles") && (ce.event.add(e, "change._change", function(t) {
            ...
            teardown: function() {
                return ce.event.remove(this, "._change"), !Pe.test(this.nodeName)
            }
        ...
        ce.fn.extend({
            ...
            is: function(t) {
                return !!f(this, "string" == typeof t && Ue.test(t) ? ce(t) : t || [], !1).length
            },
            closest: function(t, e) {
                for (var n, i = 0, o = this.length, r = [], s = Ue.test(t) || "string" != typeof t ? ce(t, e || this.context) : 0; o > i; i++)
            ...
            ce.fn[t] = function(n, i) {
                ...
                return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (o = ce.filter(i, o)), this.length > 1 && (ze[t] || (o = ce.unique(o)), Ie.test(t) && (o = o.reverse())), this.pushStack(o)
            }
        }), ce.extend({
        ...
        an.optgroup = an.option, an.tbody = an.tfoot = an.colgroup = an.caption = an.thead, an.th = an.td, ce.fn.extend({
            ...
            remove: function(t, e) {
                for (var n, i = t ? ce.filter(t, this) : this, o = 0; null != (n = i[o]); o++) e || 1 !== n.nodeType || ce.cleanData(x(n)), n.parentNode && (e && ce.contains(n.ownerDocument, n) && y(x(n, "script")), n.parentNode.removeChild(n));
                return this
            },
            empty: function() {
            ...
            html: function(t) {
                return ce.access(this, function(t) {
                    ...
                    if (!("string" != typeof t || tn.test(t) || !ce.support.htmlSerialize && Ve.test(t) || !ce.support.leadingWhitespace && Ye.test(t) || an[(Ge.exec(t) || ["", ""])[1].toLowerCase()])) {
                        t = t.replace(Je, "<$1></$2>");
                        try {
                            for (; o > i; i++) n = this[i] || {}, 1 === n.nodeType && (ce.cleanData(x(n, !1)), n.innerHTML = t);
                            n = 0
                        } catch (r) {}
                    }
            ...
            domManip: function(t, e, n) {
                ...
                var i, o, r, s, a, l, u = 0,
                    ...
                    d = t[0],
                    h = ce.isFunction(d);
                if (h || !(1 >= c || "string" != typeof d || ce.support.checkClone) && nn.test(d)) return this.each(function(i) {
                    var o = p.eq(i);
                ...
                if (c && (l = ce.buildFragment(t, this[0].ownerDocument, !1, !n && this), i = l.firstChild, 1 === l.childNodes.length && (l = i), i)) {
                    for (s = ce.map(x(l, "script"), m), r = s.length; c > u; u++) o = l, u !== f && (o = ce.clone(o, !0, !0), r && ce.merge(s, x(o, "script"))), e.call(this[u], o, u);
                    if (r)
            ...
            clone: function(t, e, n) {
                ...
                if (ce.support.html5Clone || ce.isXMLDoc(t) || !Ve.test("<" + t.nodeName + ">") ? r = t.cloneNode(!0) : (un.innerHTML = t.outerHTML, un.removeChild(r = un.firstChild)), !(ce.support.noCloneEvent && ce.support.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || ce.isXMLDoc(t)))
                    for (i = x(r), a = x(t), s = 0; null != (o = a[s]); ++s) i[s] && b(o, i[s]);
                if (e)
                    if (n)
                        for (a = a || x(t), i = i || x(r), s = 0; null != (o = a[s]); s++) v(o, i[s]);
                    else v(t, r);
                return i = x(r, "script"), i.length > 0 && y(i, !l && x(t, "script")), i = a = o = null, r
            },
            buildFragment: function(t, e, n, i) {
                for (var o, r, s, a, l, u, c, p = t.length, f = d(e), h = [], m = 0; p > m; m++)
                    if (r = t[m], r || 0 === r)
                        if ("object" === ce.type(r)) ce.merge(h, r.nodeType ? [r] : r);
                        else if (Ze.test(r)) {
                    for (a = a || f.appendChild(e.createElement("div")), l = (Ge.exec(r) || ["", ""])[1].toLowerCase(), c = an[l] || an._default, a.innerHTML = c[1] + r.replace(Je, "<$1></$2>") + c[2], o = c[0]; o--;) a = a.lastChild;
                    if (!ce.support.leadingWhitespace && Ye.test(r) && h.push(e.createTextNode(Ye.exec(r)[0])), !ce.support.tbody)
                ...
                for (a && f.removeChild(a), ce.support.appendChecked || ce.grep(x(h, "input"), w), m = 0; r = h[m++];)
                    if ((!i || -1 === ce.inArray(r, i)) && (s = ce.contains(r.ownerDocument, r), a = x(f.appendChild(r), "script"), s && y(a), n))
            ...
            cleanData: function(t, e) {
                for (var n, i, o, r, s = 0, a = ce.expando, l = ce.cache, u = ce.support.deleteExpando, c = ce.event.special; null != (n = t[s]); s++)
                    if ((e || ce.acceptData(n)) && (o = n[a], r = o && l[o])) {
                        ...
                        l[o] && (delete l[o], u ? delete n[a] : typeof n.removeAttribute !== V ? n.removeAttribute(a) : n[a] = null, ee.push(o))
                    }
            },
            _evalUrl: function(t) {
                return ce.ajax({
        ...
        ce.fn.extend({
            ...
            style: function(t, n, i, o) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    ...
                    if (s = typeof i, "string" === s && (r = xn.exec(i)) && (i = (r[1] + 1) * r[2] + parseFloat(ce.css(t, n)), s = "number"), !(null == i || "number" === s && isNaN(i) || ("number" !== s || ce.cssNumber[l] || (i += "px"), ce.support.clearCloneStyle || "" !== i || 0 !== n.indexOf("background") || (u[n] = "inherit"), a && "set" in a && (i = a.set(t, i, o)) === e))) try {
                        u[n] = i
                    } catch (c) {}
                }
            },
            css: function(t, n, i, o) {
                var r, s, a, l = ce.camelCase(n);
                return n = ce.cssProps[l] || (ce.cssProps[l] = T(t.style, l)), a = ce.cssHooks[n] || ce.cssHooks[l], a && "get" in a && (s = a.get(t, !0, i)), s === e && (s = fn(t, n, o)), "normal" === s && n in Cn && (s = Cn[n]), "" === i || i ? (r = parseFloat(s), i === !0 || ce.isNumeric(r) ? r || 0 : s) : s
            }
            ...
            ce.cssHooks[n] = {
                ...
                set: function(t, e, i) {
                    var o = i && pn(t);
                    return E(t, e, i ? N(t, n, i, ce.support.boxSizing && "border-box" === ce.css(t, "boxSizing", !1, o), o) : 0)
                }
            }
            ...
            set: function(t, e) {
                ...
                n.zoom = 1, (e >= 1 || "" === e) && "" === ce.trim(r.replace(dn, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === e || i && !i.filter) || (n.filter = dn.test(r) ? r.replace(dn, o) : r + " " + o)
            }
        }), ce(function() {
            ce.support.reliableMarginRight || (ce.cssHooks.marginRight = {
                ...
                ce.cssHooks[n] = {
                    get: function(t, i) {
                        return i ? (i = fn(t, n), bn.test(i) ? ce(t).position()[n] + "px" : i) : e
                    }
                }
            })
        ...
        ce.fn.extend({
            ...
            serializeArray: function() {
                return this.map(function() {
                    ...
                    var t = this.type;
                    return this.name && !ce(this).is(":disabled") && An.test(this.nodeName) && !Dn.test(t) && (this.checked || !en.test(t))
                }).map(function(t, e) {
                    var n = ce(this).val();
        ...
        try {
            ...
            Ln = J.createElement("a"), Ln.href = "", Ln = Ln.href
        }
        jn = Bn.exec(Ln.toLowerCase()) || [], ce.fn.load = function(t, n, i) {
            ...
            ajax: function(t, n) {
                ...
                var o, r, s, a, l, u, c, p, f = ce.ajaxSetup({}, n),
                    ...
                    T = {
                        ...
                        getResponseHeader: function(t) {
                            ...
                            if (2 === x) {
                                if (!p)
                                    for (p = {}; e = Pn.exec(a);) p[e[1].toLowerCase()] = e[2];
                                e = p[t.toLowerCase()]
                            }
                ...
                if (m.promise(T).complete = g.add, T.success = T.done, T.error = T.fail, f.url = ((t || f.url || Ln) + "").replace(On, "").replace(Wn, jn[1] + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = ce.trim(f.dataType || "*").toLowerCase().match(fe) || [""], null == f.crossDomain && (o = Bn.exec(f.url.toLowerCase()), f.crossDomain = !(!o || o[1] === jn[1] && o[2] === jn[2] && (o[3] || ("http:" === o[1] ? "80" : "443")) === (jn[3] || ("http:" === jn[1] ? "80" : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = ce.param(f.data, f.traditional)), L(In, f, n, T), 2 === x) return T;
                u = f.global, u && 0 === ce.active++ && ce.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !Mn.test(f.type), s = f.url, f.hasContent || (f.data && (s = f.url += (Fn.test(s) ? "&" : "?") + f.data, delete f.data), f.cache === !1 && (f.url = qn.test(s) ? s.replace(qn, "$1_=" + Hn++) : s + (Fn.test(s) ? "&" : "?") + "_=" + Hn++)), f.ifModified && (ce.lastModified[s] && T.setRequestHeader("If-Modified-Since", ce.lastModified[s]), ce.etag[s] && T.setRequestHeader("If-None-Match", ce.etag[s])), (f.data && f.hasContent && f.contentType !== !1 || n.contentType) && T.setRequestHeader("Content-Type", f.contentType), T.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + zn + "; q=0.01" : "") : f.accepts["*"]);
        ...
        ce.ajaxSetup({
            ...
            return l || "jsonp" === n.dataTypes[0] ? (r = n.jsonpCallback = ce.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, l ? n[l] = n[l].replace(Vn, "$1" + r) : n.jsonp !== !1 && (n.url += (Fn.test(n.url) ? "&" : "?") + n.jsonp + "=" + r), n.converters["script json"] = function() {
                return a || ce.error(r + " was not called"), a[0]
            }, n.dataTypes[0] = "json", s = t[r], t[r] = function() {
                a = arguments
            }, o.always(function() {
                t[r] = s, n[r] && (n.jsonpCallback = i.jsonpCallback, Qn.push(r)), a && ce.isFunction(s) && s(a[0]), a = s = e
            }), "script") : e
        });
        var Yn, Jn, Gn = 0,
        ...
        ce.ajaxSettings.xhr = t.ActiveXObject ? function() {
            return !this.isLocal && q() || P()
        } : q, Jn = ce.ajaxSettings.xhr(), ce.support.cors = !!Jn && "withCredentials" in Jn, Jn = ce.support.ajax = !!Jn, Jn && ce.ajaxTransport(function(n) {
                        ...
                        l.send(n.hasContent && n.data || null), i = function(t, o) {
                            ...
                            try {
                                if (i && (o || 4 === l.readyState))
                                    if (i = e, s && (l.onreadystatechange = ce.noop, Kn && delete Yn[s]), o) 4 !== l.readyState && l.abort();
                                    else {
                            ...
                            p && r(a, c, p, u)
                        }, n.async ? 4 === l.readyState ? setTimeout(i) : (s = ++Gn, Kn && (Yn || (Yn = {}, ce(t).unload(Kn)), Yn[s] = i), l.onreadystatechange = i) : i()
                    },
                    abort: function() {
                        i && i(e, !0)
                    }
        ...
        ce.Animation = ce.extend(W, {
            ...
            var n, i, o = {
                ...
                r = this[0],
                s = r && r.ownerDocument;
            return s ? (n = s.documentElement, ce.contains(n, r) ? (typeof r.getBoundingClientRect !== V && (o = r.getBoundingClientRect()), i = z(s), {
            ...
            setOffset: function(t, e, n) {
                ...
                var o, r, s = ce(t),
                    ...
                    p = {},
                    f = {};
                c ? (f = s.position(), o = f.top, r = f.left) : (o = parseFloat(l) || 0, r = parseFloat(u) || 0), ce.isFunction(e) && (e = e.call(t, n, a)), null != e.top && (p.top = e.top - a.top + o), null != e.left && (p.left = e.left - a.left + r), "using" in e ? e.using.call(t, p) : s.css(p)
            }
        }, ce.fn.extend({
            position: function() {
                if (this[0]) {
    ...
    e.DEFAULTS = {
        ...
        if (!o.hasClass("active")) {
            if (this.$indicators.length && (this.$indicators.find(".active").removeClass("active"), this.$element.one("slid.bs.carousel", function() {
                ...
                if (this.$element.trigger(u), u.isDefaultPrevented()) return;
                i.removeClass("active"), o.addClass("active"), this.sliding = !1, this.$element.trigger("slid.bs.carousel")
            }
    ...
    e.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (r) {
                ...
                i = "bottom" == i && s.top + s.height + l - p > d ? "top" : "top" == i && s.top - p - l < 0 ? "bottom" : "right" == i && s.right + a > f ? "left" : "left" == i && s.left - a < h ? "right" : i, n.removeClass(c).addClass(i)
            }
    ...
    t.fn.scrollUp = function(e) {
        ...
        var o, r, s, a, l, u, c, p = t.fn.scrollUp.settings = t.extend({}, t.fn.scrollUp.defaults, i),
            f = !1;
        switch (c = p.scrollTrigger ? t(p.scrollTrigger) : t("<a/>", {
            id: p.scrollName,
            href: "#top"
        }), p.scrollTitle && c.attr("title", p.scrollTitle), c.appendTo("body"), p.scrollImg || p.scrollTrigger || c.html(p.scrollText), c.css({
            display: "none",
            position: "fixed",
            zIndex: p.zIndex
        }), p.activeOverlay && t("<div/>", {
            ...
            case "fade":
                o = "fadeIn", r = "fadeOut", s = p.animationSpeed;
                break;
            case "slide":
                o = "slideDown", r = "slideUp", s = p.animationSpeed;
                break;
            default:
                o = "show", r = "hide", s = 0
        }
        a = "top" === p.scrollFrom ? p.scrollDistance : t(n).height() - t(e).height() - p.scrollDistance, l = t(e).scroll(function() {
            t(e).scrollTop() > a ? f || (c[o](s), f = !0) : f && (c[r](s), f = !1)
        }), p.scrollTarget ? "number" == typeof p.scrollTarget ? u = p.scrollTarget : "string" == typeof p.scrollTarget && (u = Math.floor(t(p.scrollTarget).offset().top)) : u = 0, c.click(function(e) {
